...
public class UpgradeEconomy extends GameRequest<GameStateDelta>{

	public final Integer star;
	
	public UpgradeEconomy(Integer player, String userName, Long game, Integer star) {
		super(RequestType.UpgradeEcon, player, userName, game);
    ...
    kind.appendChild(doc.createTextNode("upgrade_economy"));
